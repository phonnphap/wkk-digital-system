'use client'
// app/login/LoginContent.tsx  ← ไฟล์ใหม่ที่แยกออกมา
...
export default function LoginContent() {
  ...
  const params   = useSearchParams()   // ✅ อยู่ใน Suspense แล้ว ปลอดภัย
        ...
        <div className="relative px-10 py-8 text-center overflow-hidden"
          ...
          <div className="flex items-center justify-center gap-3.5 mb-4">
            <div className="relative w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 bg-white"
              ...
              <img src="/school-logo.png" alt="โลโก้โรงเรียนวัดเขียนเขต" className="w-10 h-10 object-contain" />
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3.5">
            <div>
              ...
              <input
                ...
                disabled={loading !== null} required
              />
            </div>
            <div>
...
function SSOButton({
  ...
  provider: 'microsoft'; label: string; loading: boolean; disabled: boolean; onClick: () => void
}) {
  return (
