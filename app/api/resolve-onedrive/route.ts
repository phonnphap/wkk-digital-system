...
// ──────────────────────────────────────────────────────────
// ใช้ร่วมกันทั้งระบบลา และระบบ PLC — แก้ปัญหา @microsoft.graph.downloadUrl
// ที่ได้ตอนอัพโหลดไฟล์ "หมดอายุ" หลังผ่านไปสักพัก (ลิงก์ pre-authenticated ชั่วคราว)
// ทำให้รูปภาพ/เอกสารแนบไม่ขึ้นเมื่อเปิดดูภายหลัง ไม่ว่าจะ login ด้วย role ไหนก็ตาม
// (เพราะลิงก์หมดอายุจริง ไม่เกี่ยวกับสิทธิ์ผู้ใช้)
//
// รับ "path" (relative path ที่บันทึกไว้ตอนอัพโหลด เช่น "Plc/PLC_xxx.jpg")
// แล้วไปขอ downloadUrl ใหม่จาก Graph API ทุกครั้งที่เรียก ทำให้ลิงก์สดเสมอ
// ══════════════════════════════════════════════════════════
